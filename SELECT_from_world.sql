...
/*
#1
Read the notes about this table. Observe the result of running a simple SQL
command.
*/
...
/*
#7
Two ways to be big: A country is big if it has an area of more than 3 million sq
km or it has a population of more than 250 million.
...
For South America show population in millions and GDP in billions to 2 decimal
places.
*/
SELECT name,
...
/*
#10
Show the name and per-capita GDP for those countries with a GDP of at least one
...
/*
#11
Show the name and capital where the name and the capital have the same number
of characters.
*/
SELECT name, capital
FROM world
